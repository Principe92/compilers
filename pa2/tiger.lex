...
<INITIAL>null         => (Tokens.NIL(yypos, yypos+3));
...
<INITIAL>or          => (Tokens.OR(yypos, yypos+1));
...
<INITIAL>\"[a-zA-Z0-9]*\"  => (Tokens.STRING(yytext, yypos, yypos+size(yytext)));
...
<INITIAL>eof         => (Tokens.EOF(yypos, yypos+3));
